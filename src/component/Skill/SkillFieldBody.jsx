...
const SkillFieldBody = ({formData, setFormData}) => {
                ...
                <div class="card-body !py-2">
                    <div class=" !mb-5 ">
                        <div class="mb-3 ">
                            ...
                            <input
                                value={formData.sk_title}
                                onChange={(e) => setFormData(prev => ({ ...prev, sk_title: e.target.value }))}
                                class="py-3 w-full px-4 text-gray-500 block border-gray-200 rounded-sm text-md focus:border-blue-600 focus:ring-0 "/>
                        </div>
                        <div class="mb-3 ">
                            <h4 class="text-gray-500 text-lg font-semibold mb-2">Percentage</h4>
                            <input value={formData.sk_per}
                                onChange={(e) => setFormData(prev => ({ ...prev, sk_per: e.target.value }))}
                                type="number" min="0" max="100" step={1} class="py-3 w-full px-4 text-gray-500 block border-gray-200 rounded-sm text-md focus:border-blue-600 focus:ring-0 "/>
                        </div>
                    </div>
                </div>
            </div>
