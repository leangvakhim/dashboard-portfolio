...
const BlogFieldBody = ({formData, setFormData, selectedImage, setSelectedImage}) => {
    ...
    return (
        <div>
                            ...
                            <div class=" !mb-5 ">
                                <div class="mb-3 ">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setFormData(prev => ({ ...prev, b_title: e.target.value }))}
                                        class="py-3 w-full px-4 text-gray-500 block border-gray-200 rounded-sm text-md focus:border-blue-600 focus:ring-0 "/>
                                </div>
                                <div class="mb-6 ">
                                    <h4 class="text-gray-500 text-lg font-semibold mb-2">Subtitle</h4>
                                    <textarea
                                        value={formData.b_subtitle}
                                        onChange={(e) => setFormData(prev => ({ ...prev, b_subtitle: e.target.value }))}
                                        class=" w-full h-44 px-4 text-gray-500 block border-gray-200 rounded-sm text-md focus:border-blue-600 focus:ring-0 "/>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="flex gap-3 mt-2 justify-center">
                                                    <svg
                                                        ...
                                                        onChange={(e) => setFormData({ ...formData, b_img: e.target.value })}
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-x-6 gap-x-0 lg:gap-y-3 gap-y-6 mt-6">
                <div class="col-span-2">
                    <div class="card ">
                        <div class="card-body !py-2">
                            <div class=" !mb-5 ">
                                <div class="mb-3 ">
                                    <h4 class="text-gray-500 text-lg font-semibold mb-2">Date</h4>
                                    <input
                                        value={formData.b_date}
                                        onChange={(e) => setFormData(prev => ({ ...prev, b_date: e.target.value }))}
                                        type="date" class="py-3 w-full px-4 text-gray-500 block border-gray-200 rounded-sm text-md focus:border-blue-600 focus:ring-0 "/>
                                </div>
                                <div class="mb-6 ">
                                    <h4 class="text-gray-500 text-lg font-semibold mb-2">Details</h4>
                                    <JoditEditor
                                        value={formData.b_detail}
                                        config={config}
                                        onChange={(newContent) => setFormData(prev => ({ ...prev, b_detail: newContent } ))}
                                    />
                                </div>
