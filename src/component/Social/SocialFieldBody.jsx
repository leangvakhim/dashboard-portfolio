...
const SocialFieldBody = ({formData, setFormData, selectedImage, setSelectedImage}) => {
                            ...
                            <div class=" !mb-5 ">
                                <div class="mb-3 ">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setFormData(prev => ({ ...prev, s_title: e.target.value }))}
                                        class="py-3 w-full px-4 text-gray-500 block border-gray-200 rounded-sm text-md focus:border-blue-600 focus:ring-0 "/>
                                </div>
                                <div class="mb-6 ">
                                    <h4 class="text-gray-500 text-lg font-semibold mb-2">Link</h4>
                                    <textarea
                                        value={formData.s_link}
                                        onChange={(e) => setFormData(prev => ({ ...prev, s_link: e.target.value }))}
                                            ...
                                            <div>
                                                ...
                                                <div className="flex gap-3 mt-2 justify-center">
                                                    <svg
                                                        ...
                                                        value={formData.s_img}
                                                        onChange={(e) => setFormData({ ...formData, s_img: e.target.value })}
...
export default SocialFieldBody