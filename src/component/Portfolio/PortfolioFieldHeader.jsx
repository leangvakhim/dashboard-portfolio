...
const PortfolioFieldHeader = ({onSave}) => {
    return (
        <header class=" bg-white shadow-md rounded-md w-full text-sm py-4 px-6">
            <nav class=" w-ful flex items-center justify-between" aria-label="Global">
                <ul class="icon-nav flex items-center gap-4">
                    ...
                    <li class="relative">
                        <div class="">
                            <Link to="/portfolio" class="btn-outline-danger font-medium text-[15px] w-full hover:bg-red-500 hover:text-white">Return</Link>
                        </div>
                    </li>
                    <li class="relative">
                        <div class="">
...
export default PortfolioFieldHeader