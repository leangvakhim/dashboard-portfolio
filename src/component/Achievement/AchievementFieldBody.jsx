...
const AchievementFieldBody = ({formData, setFormData, selectedImage, setSelectedImage}) => {
                            ...
                            <div class=" !mb-5 ">
                                ...
                                <h4 class="text-gray-500 text-lg font-semibold mb-2">Type</h4>
                                    <select
                                        ...
                                        onChange={(e) => setFormData(prev => ({ ...prev, a_type: e.target.value }))}
                                            ...
                                            <div>
                                                ...
                                                <div className="flex gap-3 mt-2 justify-center">
                                                    <svg
                                                        ...
                                                        value={formData.a_img}
                                                        onChange={(e) => setFormData({ ...formData, a_img: e.target.value })}
...
export default AchievementFieldBody