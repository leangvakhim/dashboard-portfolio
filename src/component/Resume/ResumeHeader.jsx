            ...
            <nav class=" w-ful flex items-center justify-between" aria-label="Global">
                <ul class="icon-nav flex items-center gap-4">
                    ...
                    <li class="relative">
                        <div class="">
                            <Link
                                onClick={() => localStorage.removeItem('resumeID')}
                                to="/resume-detail" class="btn-outline-primary font-medium text-[15px] w-full hover:bg-blue-600 hover:text-white">Add Resume</Link>
                        </div>
                    </li>
                </ul>
                <Profile/>
