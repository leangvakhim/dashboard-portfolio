...
const ResumeFieldBody = ({formData, setFormData}) => {
                        ...
                        <div class="card-body !py-2">
                            <div class=" !mb-5 ">
                                <div class="mb-3 ">
                                    ...
                                    <input
                                        value={formData.r_title}
                                        onChange={(e) => setFormData(prev => ({ ...prev, r_title: e.target.value }))}
                                ...
                                <div class="mb-6 ">
                                    ...
                                    <JoditEditor
                                        value={formData.r_detail}
                                        config={config}
                                        onChange={(newContent) => setFormData(prev => ({ ...prev, r_detail: newContent } ))}
                                    />
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-span-1">
                    <div class="card ">
                        <div class="card-body !py-2">
                            <div class=" !mb-5 ">
                                <div class="mb-3 ">
                                    <h4 class="text-gray-500 text-lg font-semibold mb-2">Duration</h4>
                                    <input
                                        value={formData.r_duration}
                                        onChange={(e) => setFormData(prev => ({ ...prev, r_duration: e.target.value }))}
                                        type="text" class="py-3 w-full px-4 text-gray-500 block border-gray-200 rounded-sm text-md focus:border-blue-600 focus:ring-0 "/>
                                </div>
                                <div class="mb-3 ">
                                    <h4 class="text-gray-500 text-lg font-semibold mb-2">Type</h4>
                                    <select
                                        value={formData.r_type}
                                        onChange={(e) => setFormData(prev => ({ ...prev, r_type: e.target.value }))}
...
export default ResumeFieldBody