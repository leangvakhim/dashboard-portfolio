...
const InformationFieldBody = ({formData, setFormData, selectedImage, setSelectedImage}) => {
    ...
    return (
        <div>
                            ...
                            <div class=" !mb-5 ">
                                <div class="mb-3 ">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setFormData(prev => ({ ...prev, i_title: e.target.value }))}
                                ...
                                <div class="mb-6 ">
                                    ...
                                    <textarea
                                        value={formData.i_detail}
                                        onChange={(e) => setFormData(prev => ({ ...prev, i_detail: e.target.value }))}
                                            ...
                                            <div>
                                                ...
                                                <div className="flex gap-3 mt-2 justify-center">
                                                    <svg
                                                        ...
                                                        value={formData.i_img}
                                                        onChange={(e) => setFormData({ ...formData, i_img: e.target.value })}
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-x-6 gap-x-0 lg:gap-y-3 gap-y-6 mt-5">
                <div class="col-span-2">
                    <div class="card ">
                        <div class="card-body !py-2">
                            <div class=" !mb-5 ">
                                <div class="mb-3 ">
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => setFormData(prev => ({ ...prev, i_type: e.target.value }))}
...
export default InformationFieldBody